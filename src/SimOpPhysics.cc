/**
 * @file SimOpPhysics.cc
 * @brief Implementation of the SimOpPhysics custom physics list.
 *
 * This file implements the `SimOpPhysics` class, a custom physics
 ...
 *
 * Usage:
 *  - Instantiate `SimOpPhysics` and set it as the physics list in
