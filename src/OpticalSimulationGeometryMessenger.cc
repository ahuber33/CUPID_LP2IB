...
OpticalSimulationGeometryMessenger::OpticalSimulationGeometryMessenger(
    ...
    fGeometryLMOLengthCmd = new G4UIcmdWithADoubleAndUnit(
        "/OpticalSimulation/geometry/setLMOLength", this);
    ...
    fGeometryLMOWidthCmd = new G4UIcmdWithADoubleAndUnit(
        "/OpticalSimulation/geometry/setLMOWidth", this);
    ...
    fGeometryLMOThicknessCmd = new G4UIcmdWithADoubleAndUnit(
        "/OpticalSimulation/geometry/setLMOThickness", this);
     ...
     */
    fGeometryLMOLYCmd =
        new G4UIcmdWithADouble("/OpticalSimulation/materials/setLMOLY", this);
