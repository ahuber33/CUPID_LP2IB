...
class Geometry {
  public:
    ...
    /**
     * @brief Create an octogonal LD.
     * @param name Name of the LD volume.
     * @param material G4Material defined
     * @return Pointer to the created G4LogicalVolume.
     */
    G4LogicalVolume *GetOctogonalVolume(G4String name, G4Material *material, std::vector<G4TwoVector> LDpolygon, G4double LDthickness);
